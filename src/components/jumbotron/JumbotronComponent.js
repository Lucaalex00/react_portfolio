...
const Jumbotron = () => {
  return (
    <div className="jumbotron flex items-center justify-center h-[400px] mt-[150px] hover:shadow-md ease-linear duration-500 w-2/3 mx-auto overflow-auto">
      <div className="jumbo_container flex items-center gap-5 w-full max-w-4xl mx-auto rounded-lg overflow-hidden">
        ...
        <div className="text_side w-2/3 py-2">
          <h1 className="text-2xl text-gray-100 text-shadow-lg font-bold mb-5"><Link to="/aboutme" className='hover:text-red-100 duration-500'>Luca</Link>, 24 years old.</h1>
