...
const ContactPage = () => {
  ...
  return (
      <div className="min-h-full w-2/3 bg-gray-100 flex flex-col md:flex-row my-[150px] lg:p-8 p-2">
      <div className="md:w-2/3 flex flex-col space-y-4">
        ...
        <a
          ...
          className="bg-blue-600 sm:p-6 p-3 rounded-lg shadow-lg flex items-center space-x-3 hover:opacity-90 transition duration-300"
        >
          <img
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-gray-800 sm:p-6 p-3 rounded-lg shadow-lg flex items-center space-x-3 hover:opacity-90 transition duration-300"
        >
          <img
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-pink-600 sm:p-6 p-3 rounded-lg shadow-lg flex items-center space-x-3 hover:opacity-90 transition duration-300"
        >
          <img
        ...
        <a
          ...
          download
          className="bg-red-700 sm:p-6 p-3 rounded-lg shadow-lg flex items-center space-x-3 hover:opacity-90 transition duration-300"
        >
          <img
